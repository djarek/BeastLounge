...
public:
    ...
    on_stop() override
    {
        net::post(
            ...
            bind_self(this, &http_session_base::do_stop));
    }
...
public:
    ...
    do_run()
    {
        ...
        stream_.async_handshake(
            ...
            storage_.data(),
            bind_self(this, &ssl_http_session_impl::on_handshake));
    }
    ...
    do_close()
    {
        ...
        stream_.async_shutdown(
            bind_self(this, &ssl_http_session_impl::on_shutdown));
    }
